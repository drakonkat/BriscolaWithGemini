...
export const WaifuSelector = ({ language, onWaifuSelected }: WaifuSelectorProps) => {
    ...
    return (
        <div className="waifu-selection">
            ...
            <div className="waifu-selector-container">
                ...
                <div className="random-waifu-card" onClick={() => onWaifuSelected(null)} role="button" tabIndex={0} aria-label={T.randomOpponent}>
