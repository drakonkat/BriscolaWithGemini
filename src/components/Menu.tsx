        ...
        <div className="menu">
            ...
            <div className="menu-content" data-tutorial-id="welcome">
                ...
                <div className="menu-section" data-tutorial-id="difficulty">
                    ...
                    <div className="menu-section-header details-header" onClick={() => uiStore.toggleDifficultyDetails()}>
                ...
                <div className="menu-section">
                    <div className="menu-section-header" onClick={() => uiStore.toggleWaifuDetails()}>
