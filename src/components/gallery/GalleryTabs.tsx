...
export const GalleryTabs: React.FC<GalleryTabsProps> = ({ language, activeTab, setActiveTab }) => {
    ...
    return (
        <div className="gallery-tabs" data-tutorial-id="gallery-tabs">
            <button className={`tab-button ${activeTab === 'gacha' ? 'active' : ''}`} onClick={() => setActiveTab('gacha')}>
            ...
            <button className={`tab-button ${activeTab === 'backgrounds' ? 'active' : ''}`} onClick={() => setActiveTab('backgrounds')}>
