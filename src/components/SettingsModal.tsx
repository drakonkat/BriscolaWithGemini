...
export const SettingsModal = observer(({ isOpen, onClose, language }: SettingsModalProps) => {
    if (!isOpen) {
        return null;
    }
            ...
            <div className="rules-modal" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="settings-modal-content">
                    ...
                    <div className="settings-selector">
                        ...
                        <div className="select-wrapper">
                            <select id="language-select-modal" value={currentLanguage} onChange={(e) => gameSettingsStore.setLanguage(e.target.value as any)}>
