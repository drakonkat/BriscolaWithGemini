...
export const MissionsModal = observer(({ isOpen, onClose }) => {
    ...
    const renderMissionList = (missions, states) => {
                    ...
                    return (
                        <div key={mission.id} className={`mission-item ${state?.claimed ? 'claimed' : ''}`}>
                            <div className="mission-details">
                                <p className="mission-description">{TM.descriptions[mission.id]?.replace('{target}', mission.target.toString()) ?? mission.id}</p>
                                ...
                                <div className="mission-rewards-container">
                                    ...
                                    <div className="mission-rewards">
                                        {Object.entries(mission.rewards).map(([type, amount]) => (
                                            <RewardIcon key={type} type={type} amount={amount} />
                                        ))}
                                    </div>
                                </div>
