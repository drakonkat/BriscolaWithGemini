...
import { GachaUnlockAnimation } from '../shared/GachaUnlockAnimation';
import { GachaRollingAnimation } from '../shared/GachaRollingAnimation';
...
export const GalleryModal = observer(({ isOpen, onClose, language, backgrounds, unlockedBackgrounds, waifuCoins, onGachaRoll, onGachaMultiRoll, hasRolledGacha, isRolling, gachaAnimationState, onAnimationEnd, onImageSelect, isNsfwEnabled }) => {
