...
import { getCardPoints, shuffleDeck } from './utils.js';
 ...
 */
export const initializeRoguelikeDeck = (deck, level) => {
 ...
 */
const getRoguelikeCardRank = (card) => {
 ...
 */
export const getRoguelikeTrickWinner = (playedCards, starter, briscola, activePowers = []) => {
 ...
 */
export const determineWeaknessWinner = (humanElement, aiElement) => {
