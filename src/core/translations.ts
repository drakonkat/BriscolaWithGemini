...
export const translations = {
  it: {
    ...
    randomOpponentModalDesc: "Affronterai una delle tre avversarie (Sakura, Rei o Kasumi) scelta casualmente all'inizio della partita.",
    waifuDetails: (name: string) => `Dettagli di ${name}`,
    rulesTitle: "Regolamento",
    refreshBackground: "Nuovo Sfondo",
    waifuCoinRulesTitle: "Regole Waifu Coin",
    waifuCoinRuleLoss: (amount: number) => `Sconfitta: +${amount} WC`,
    waifuCoinRuleWin61: (amount: number) => `Vittoria (61-80 punti): +${amount} WC`,
    waifuCoinRuleWin81: (amount: number) => `Vittoria (81-100 punti): +${amount} WC`,
    waifuCoinRuleWin101: (amount: number) => `Vittoria (101+ punti): +${amount} WC`,
    waifuCoinRuleWinNightmare: (amount: number) => `Vittoria (Incubo): +${amount} WC`,
    waifuCoinRuleWinApocalypse: (amount: number) => `Vittoria (Apocalisse): +${amount} WC`,
    ...
    waifuCoinDifficultyMultiplierNightmare: "Incubo: +250 WC",
    waifuCoinDifficultyMultiplierApocalypse: "Apocalisse: +500 WC",
    ...
    aiPlayedYourTurn: (name: string) => `${name} ha giocato. Ora tocca a te.`,
    youWonTrick: (points: number) => `Hai vinto la mano! +${points} punti.`,
    aiWonTrick: (name: string, points: number) => `${name} ha vinto la mano. +${points} punti.`,
    scoreYou: "Tu",
    ...
    chatWith: (name: string) => `Chatta con ${name}`,
    ...
    waifuGenericTeasePrompt: (name: string, personality: string, aiScore: number, humanScore: number) => 
    ...
    gallery: {
        ...
        rarityUnlocked: (rarity: string) => `Hai sbloccato un ${rarity}!`,
        ...
        craftButton: (cost: number) => `Crea (${cost})`,
        gachaNotEnoughShards: "Non hai abbastanza Frammenti!",
        gachaNoLockedToCraft: (rarity: string) => `Hai già tutti gli sfondi di rarità ${rarity}!`,
        craftKeySuccess: (rarity: string) => `Hai creato una Chiave ${rarity}!`,
    ...
    missions: {
        ...
        descriptions: {
            ...
            daily_win_easy: "Vinci {target} partita a difficoltà Facile o superiore.",
            ...
            weekly_play_cards_spade: "Gioca {target} carte di Spade.",
            weekly_win_roguelike: "Completa {target} run in modalità Roguelike.",
    ...
    challengeMatch: {
      ...
      challengeLossMessage: (name: string) => `${name} ti ha sconfitto, ma non hai perso la chiave. Riprova quando vuoi!`,
    ...
    followerAbilityArmed: (waifu: string, ability: string) => `${waifu} usa ${ability}!`,
    abilityReady: "Pronta",
    abilities: {
    ...
    history: {
      ...
      abilityUsed: (waifu: string, ability: string) => `${waifu} ha usato ${ability}`,
      bonusReasons: {
    ...
    roguelike: {
        ...
        newFollowerMessage: (name: string) => `${name} si è unita a te! La sua abilità sarà disponibile nelle prossime partite.`,
        continueRun: "Continua l'avventura",
        runCompleted: "Avventura Completata!",
        runCompletedMessage: (winnings: number) => `Hai sconfitto tutte le avversarie! Hai guadagnato ${winnings} WC.`,
        runFailed: "Avventura Fallita",
        runFailedMessage: (winnings: number) => `Sei stato sconfitto. Hai comunque guadagnato ${winnings} WC per i tuoi sforzi.`,
        ...
        levelUpMessage: (level: number) => `Hai completato il livello ${level - 1}. Scegli un nuovo potere o potenzia quello iniziale.`,
        ...
        powers: {
            ...
            bonus_point_per_trick: {
                name: "Tributo Divino",
                desc: (level: number) => `Guadagni ${level} punto/i bonus per ogni mano che vinci.`
            },
            king_bonus: {
                name: "Cacciatore di Teste",
                desc: (level: number) => `Guadagni ${level * 2} punti bonus quando vinci una mano giocando un Fante, Cavallo o Re.`
            },
            ace_of_briscola_start: {
                name: "Asso nella Manica",
                desc: (level: number) => level === 1 ? "Inizi ogni partita con una carta di briscola di valore (Asso, 3 o Re) in mano." : (level === 2 ? "Inizi ogni partita con un Asso o un 3 di briscola in mano." : "Inizi ogni partita con l'Asso e il 3 di briscola in mano.")
            },
            briscola_mastery: {
                name: "Maestria della Briscola",
                desc: (level: number) => `Guadagni ${level * 2} punti bonus quando vinci una mano giocando una carta di briscola.`
            },
            value_swap: {
                name: "Scambio di Valore",
                desc: (cooldown: number) => `Una volta ogni ${cooldown} turni, puoi scambiare una carta dalla tua mano con la briscola sul tavolo.`
            },
            last_trick_insight: {
                name: "Sesto Senso",
                desc: (level: number) => level === 1 ? "Le carte in mano all'avversaria vengono rivelate nell'ultima mano." : (level === 2 ? "Una volta ogni 3 turni, puoi rivelare la mano dell'avversaria per il turno corrente." : "Le carte in mano all'avversaria sono sempre visibili.")
            },
            third_eye: {
                name: "Terzo Occhio",
  ...
  en: {
    ...
    randomOpponentModalDesc: "You will face one of the three opponents (Sakura, Rei, or Kasumi) chosen randomly at the start of the match.",
    waifuDetails: (name: string) => `${name}'s Details`,
    rulesTitle: "Rules",
    refreshBackground: "New Background",
    waifuCoinRulesTitle: "Waifu Coin Rules",
    waifuCoinRuleLoss: (amount: number) => `Loss: +${amount} WC`,
    waifuCoinRuleWin61: (amount: number) => `Win (61-80 points): +${amount} WC`,
    waifuCoinRuleWin81: (amount: number) => `Win (81-100 points): +${amount} WC`,
    ...
    aiPlayedYourTurn: (name: string) => `${name} has played. Now it's your turn.`,
    ...
    waifuAvatarAlt: (name: string) => `${name}'s avatar`,
    ...
    gallery: {
        ...
        rarityUnlocked: (rarity: string) => `You unlocked an ${rarity}!`,
        ...
        craftButton: (cost: number) => `Craft (${cost})`,
        ...
        convertButton: "Convert",
        keyLabelR: (keys: number) => `x${keys} R Keys`,
        keyLabelSR: (keys: number) => `x${keys} SR Keys`,
        keyLabelSSR: (keys: number) => `x${keys} SSR Keys`,
        keyNameR: "Rare Key",
    ...
    missions: {
        ...
        descriptions: {
            daily_win_classic: "Win {target} classic game.",
            daily_play_cards_coppe: "Play {target} Cups cards.",
            daily_use_elemental_power: "Activate {target} elemental powers in Roguelike mode.",
            daily_win_easy: "Win {target} game on Easy difficulty or higher.",
            ...
            weekly_play_cards_spade: "Play {target} Swords cards.",
            weekly_win_roguelike: "Complete {target} Roguelike run.",
            ...
            achievement_defeat_all_waifus: "Defeat all Waifus at least once.",
            achievement_collect_all_ssr: "Collect all SSR backgrounds.",
    ...
    challengeMatch: {
      ...
      challengeLossMessage: (name: string) => `${name} has defeated you, but you didn't lose your key. Try again whenever you're ready!`,
    ...
    followerAbilityArmed: (waifu: string, ability: string) => `${waifu} uses ${ability}!`,
    abilityReady: "Ready",
    abilities: {
    ...
    history: {
      ...
      abilityUsed: (waifu: string, ability: string) => `${waifu} used ${ability}`,
      bonusReasons: {
    ...
    roguelike: {
        ...
        levelUpMessage: (level: number) => `You completed level ${level - 1}. Choose a new power or upgrade your initial one.`,
        ...
        powers: {
            ...
            bonus_point_per_trick: {
                name: "Divine Tribute",
                desc: (level: number) => `Gain ${level} bonus point(s) for each trick you win.`
            },
            king_bonus: {
                name: "Headhunter",
                desc: (level: number) => `Gain ${level * 2} bonus points when you win a trick by playing a Jack, Knight, or King.`
            },
            ace_of_briscola_start: {
                name: "Ace in the Hole",
                desc: (level: number) => level === 1 ? "Start each match with a high-value trump card (Ace, 3, or King) in your hand." : (level === 2 ? "Start each match with a trump Ace or 3 in your hand." : "Start each match with the trump Ace and 3 in your hand.")
            },
            briscola_mastery: {
                name: "Trump Mastery",
                desc: (level: number) => `Gain ${level * 2} bonus points when you win a trick by playing a trump card.`
            },
            value_swap: {
                name: "Value Swap",
                desc: (cooldown: number) => `Once every ${cooldown} turns, you can swap a card from your hand with the trump card on the table.`
            },
            last_trick_insight: {
                name: "Sixth Sense",
