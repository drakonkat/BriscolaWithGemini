...
export const translations = {
  it: {
    ...
    waifuCoinRulesTitle: "Guadagnare Waifu Coins (Modalità/Difficoltà Attuali)",
    ...
    incinerateDescription: "Rendi 0 i punti di una carta avversaria.",
    tideDescription: "Vedi la mano del tuo avversario per 5 secondi.",
    cycloneDescription: "Scambia una tua carta con una dal mazzo.",
    fortifyDescription: "Aumenta la forza di una tua carta per un turno.",
    // Roguelike Map
    roguelikeMapTitle: "Mappa Roguelike",
    currentStage: (stage: number) => `Tappa Attuale: ${stage}`,
    startStage: "Inizia Tappa",
    abandonRun: "Abbandona Run",
    runAbandoned: "Run abbandonata. Sei tornato al menu.",
    // Game Over
    ...
    // Roguelike Game Over
    stageCompleteTitle: "Tappa Completata!",
    stageCompleteMessage: (stage: number) => `Hai superato la Tappa ${stage}! Preparati per la prossima sfida.`,
    runCompleteTitle: "Run Completata!",
    runCompleteMessage: "Congratulazioni! Hai sconfitto tutte le Waifu e completato la run!",
    runFailedTitle: "Run Fallita",
    runFailedMessage: (stage: number) => `Sei stato sconfitto alla Tappa ${stage}. La run è terminata.`,
    bonusCoins: (coins: number) => `Bonus Run: +${coins} Waifu Coins`,
...
`,
  ...
  en: {
    ...
    waifuCoinRulesTitle: "Earning Waifu Coins (Current Mode & Difficulty)",
    ...
    incinerateDescription: "Reduce the point value of an opponent's card to 0.",
    tideDescription: "See your opponent's hand for 5 seconds.",
    cycloneDescription: "Swap a card from your hand with one from the deck.",
    fortifyDescription: "Increase the strength of one of your cards for one trick.",
    // Roguelike Map
    roguelikeMapTitle: "Roguelike Map",
    currentStage: (stage: number) => `Current Stage: ${stage}`,
    startStage: "Start Stage",
    abandonRun: "Abandon Run",
    runAbandoned: "Run abandoned. You have returned to the menu.",
    // Game Over
    ...
    stageCompleteMessage: (stage: number) => `You've cleared Stage ${stage}! Get ready for the next challenge.`,
    runCompleteTitle: "Run Complete!",
    runCompleteMessage: "Congratulations! You have defeated all the Waifus and completed the run!",
    runFailedTitle: "Run Failed",
    runFailedMessage: (stage: number) => `You were defeated at Stage ${stage}. The run is over.`,
    bonusCoins: (coins: number) => `Run Bonus: +${coins} Waifu Coins`,
