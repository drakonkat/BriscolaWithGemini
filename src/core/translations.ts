...
export const translations = {
  it: {
    ...
    tutorial: {
      ...
      start: "Quando sei pronto, premi qui. Iniziamo una partita di prova!",
      playerHand: "Questa è la tua mano. Clicca su una carta per giocarla quando è il tuo turno.",
      briscola: "Questa è la carta di Briscola. Le carte di questo seme battono quelle degli altri semi.",
      score: "Tieni d'occhio il tuo punteggio qui. Hai bisogno di più di 60 punti per vincere.",
      waifuStatus: "Clicca qui per vedere i dettagli sulla tua avversaria o, se la chat è abilitata, per parlare con lei!",
...
`,
  ...
  en: {
    ...
    waifuCoinDifficultyMultiplierNightmare: "Nightmare: Special 500 WC reward for winning.",
    ...
    lfoFrequency: "Modulation Speed",
    lfoDepth: "Modulation Depth",
    ...
    tutorial: {
      ...
      start: "When you're ready, press here. Let's start a practice match!",
      playerHand: "This is your hand. Click a card to play it when it's your turn.",
      briscola: "This is the Trump card (Briscola). Cards of this suit beat cards of other suits.",
      score: "Keep an eye on your score here. You need more than 60 points to win.",
      waifuStatus: "Click here to see details about your opponent or, if chat is enabled, to talk with her!",
    ...
    fortifyDescription: "Fortify: Makes the next card you play a temporary Trump.",
