...
export const translations = {
  it: {
    ...
    difficultyHardDesc: "Preparati. L'IA giocherà in modo ottimale e punirà ogni tuo errore.",
    ...
    roguelike: {
      ...
      rewardLossConsolation: "Sconfitta (Liv. 1)",
      // Events
...
`,
  ...
  en: {
    ...
    roguelike: {
      ...
      rewardLossConsolation: "Loss (Lvl 1)",
      // Events
