...
export const translations = {
  it: {
    ...
    gallery: {
        ...
        gachaCraftSuccess: (rarity: string) => `Hai creato un nuovo sfondo ${rarity}!`,
  ...
  en: {
    ...
    gallery: {
        ...
        craftingTitle: "Craft Backgrounds",
        ...
        gachaCraftSuccess: (rarity: string) => `You crafted a new ${rarity} background!`,
