...
export class ChatStore {
    ...
    resetChat = (waifu) => {
        ...
        const initialAiMessage = { sender: 'ai', text: waifu.initialChatMessage[this.rootStore.gameSettingsStore.language] };
    ...
    handleSendChatMessage = async (userMessage) => {
        ...
        const humanMessage = { sender: 'human', text: userMessage };
        ...
        try {
            ...
            if (error.toString().includes('RESOURCE_EXHAUSTED')) {
                ...
                const fallbackMessage = { sender: 'ai', text: this.T.chatFallback };
    ...
    setHasChattedThisTurn = (hasChatted) => {
