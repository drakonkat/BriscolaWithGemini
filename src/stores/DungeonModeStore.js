...
import { getImageUrl, shuffleDeck } from '../core/utils.js';
import { DUNGEON_MODIFIERS } from '../core/dungeonModifiers.js';
import { playSound } from '../core/soundManager.js';
import { initializeRoguelikeDeck, calculateRoguelikeTrickPoints, getRoguelikeTrickWinner, determineWeaknessWinner } from '../core/roguelikeGameLogic.js';
import { getCardPoints } from '../core/utils.js';
...
export class DungeonModeStore extends ClassicModeStore {
    dungeonRunState = this.loadDungeonState();
    nextDungeonMatchInfo = null;
    ...
    startDungeonRun(rarity) {
        ...
        const modifiers = selectedModifierInfos.map(modifierInfo => {
