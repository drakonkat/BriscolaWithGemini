...
const BACKGROUNDS: BackgroundItem[] = [
    { url: getImageUrl('/background/pack/base/R/R (1).png'), rarity: 'R' },
    { url: getImageUrl('/background/pack/base/R/R (2).png'), rarity: 'R' },
    { url: getImageUrl('/background/pack/base/R/R (3).png'), rarity: 'R' },
    { url: getImageUrl('/background/pack/base/R/R (4).png'), rarity: 'R' },
    { url: getImageUrl('/background/pack/base/R/R (5).png'), rarity: 'R' },
    { url: getImageUrl('/background/pack/base/R/R (6).png'), rarity: 'R' },
    { url: getImageUrl('/background/pack/base/R/R (7).png'), rarity: 'R' },
    { url: getImageUrl('/background/pack/base/R/R (8).png'), rarity: 'R' },
    { url: getImageUrl('/background/pack/base/R/R (9).png'), rarity: 'R' },
    { url: getImageUrl('/background/pack/base/R/R (10).png'), rarity: 'R' },
    { url: getImageUrl('/background/pack/base/R/R (11).png'), rarity: 'R' },
    { url: getImageUrl('/background/pack/base/R/R (12).png'), rarity: 'R' },
    { url: getImageUrl('/background/pack/base/R/R (13).png'), rarity: 'R' },
    { url: getImageUrl('/background/pack/base/R/R (14).png'), rarity: 'R' },
    { url: getImageUrl('/background/pack/base/R/R (15).png'), rarity: 'R' },
    { url: getImageUrl('/background/pack/base/R/R (16).png'), rarity: 'R' },
    { url: getImageUrl('/background/pack/base/R/R (17).png'), rarity: 'R' },
    { url: getImageUrl('/background/pack/base/R/R (18).png'), rarity: 'R' },
    { url: getImageUrl('/background/pack/base/R/R (19).png'), rarity: 'R' },
    { url: getImageUrl('/background/pack/base/R/R (20).png'), rarity: 'R' },
    { url: getImageUrl('/background/pack/base/R/R (21).png'), rarity: 'R' },
    { url: getImageUrl('/background/pack/base/R/R (22).png'), rarity: 'R' },
    { url: getImageUrl('/background/pack/base/R/R (23).png'), rarity: 'R' },
    { url: getImageUrl('/background/pack/base/R/R (24).png'), rarity: 'R' },
    { url: getImageUrl('/background/pack/base/R/R (25).png'), rarity: 'R' },
    { url: getImageUrl('/background/pack/base/R/R (26).png'), rarity: 'R' },
    { url: getImageUrl('/background/pack/base/SR/SR (1).png'), rarity: 'SR' },
    { url: getImageUrl('/background/pack/base/SR/SR (2).png'), rarity: 'SR' },
    { url: getImageUrl('/background/pack/base/SR/SR (3).png'), rarity: 'SR' },
    { url: getImageUrl('/background/pack/base/SR/SR (4).png'), rarity: 'SR' },
    { url: getImageUrl('/background/pack/base/SR/SR (5).png'), rarity: 'SR' },
    { url: getImageUrl('/background/pack/base/SR/SR (6).png'), rarity: 'SR' },
    { url: getImageUrl('/background/pack/base/SR/SR (7).png'), rarity: 'SR' },
    { url: getImageUrl('/background/pack/base/SR/SR (8).png'), rarity: 'SR' },
    { url: getImageUrl('/background/pack/base/SR/SR (9).png'), rarity: 'SR' },
    { url: getImageUrl('/background/pack/base/SR/SR (10).png'), rarity: 'SR' },
    { url: getImageUrl('/background/pack/base/SR/SR (11).png'), rarity: 'SR' },
    { url: getImageUrl('/background/pack/base/SR/SR (12).png'), rarity: 'SR' },
    { url: getImageUrl('/background/pack/base/SR/SR (13).png'), rarity: 'SR' },
    { url: getImageUrl('/background/pack/base/SSR/SSR (1).png'), rarity: 'SSR' },
    { url: getImageUrl('/background/pack/base/SSR/SSR (2).png'), rarity: 'SSR' },
    { url: getImageUrl('/background/pack/base/SSR/SSR (3).png'), rarity: 'SSR' },
    { url: getImageUrl('/background/pack/base/SSR/SSR (4).png'), rarity: 'SSR' },
    { url: getImageUrl('/background/pack/base/SSR/SSR (5).png'), rarity: 'SSR' },
    { url: getImageUrl('/background/pack/base/SSR/SSR (6).png'), rarity: 'SSR' },
    { url: getImageUrl('/background/pack/base/SSR/SSR (7).png'), rarity: 'SSR' },

];

export const DUNGEON_REWARD_BACKGROUNDS: Record<'R' | 'SR' | 'SSR', BackgroundItem> = {
    R: { url: getImageUrl('/background/dungeon/base/R.png'), rarity: 'R' },
    SR: { url: getImageUrl('/background/dungeon/base/SR.png'), rarity: 'SR' },
    SSR: { url: getImageUrl('/background/dungeon/base/SSR.png'), rarity: 'SSR' },
};
